...
<section class="cell grid-container grid-x align-right text-center
            ...
            <ul class="cell hover grid-x grid-container text-center menu
                ...
                <li class="cell small-6 medium-4 tabs-title">
                    ...
                    >
                        <figure class="hover-box">
                            <img src="$ThemeDir/images/home/sculptures.jpg" alt="Sculpures">
                            <figcaption>
                                <h3>SCULPUTRES</h3>
                            </figcaption>
                        </figure>
                ...
                <li class="cell small-6 medium-4 tabs-title">
                    ...
                    >
                        <figure class="hover-box">
                            <img src="$ThemeDir/images/home/illustrations.jpg" alt="Illustrations">
                            <figcaption>
                                <h3>ILLUSTRATIONS</h3>
                            </figcaption>
                        </figure>
                    ...
                    <div class="grid-x align-right">
                        ...
                        <div class="cell small-12 medium-8 large-9 grid-x
                            ...
                            <section class="cell grid-x
                                ...
                                <div>
                                    <img class="gallery" src="$ThemeDir/images/home/art/d30.jpg" alt="">
                                </div>
                            </section>
                            <section class="cell grid-x
                                text-center
                                ...
                                <div>
                                    <img class="gallery" src="https://via.placeholder.com/600x600" alt="">
                                </div>
                            </section>
                        </div>
                    </div>
